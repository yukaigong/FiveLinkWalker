  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==3) {
    c3_FLWSim_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
       ...
       case 3:
        {
          ...
          sf_c3_FLWSim_get_check_sum(plhs);
          break;
        }
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1681428618U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3317911277U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2023448843U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4213193776U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(633227502U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(465063594U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(614787455U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1394733696U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "eEG8WCpihWosRSTVPDlfdD") == 0) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "SUHnQZZordIgaiCBDncznF") == 0) {
          extern mxArray *sf_c3_FLWSim_get_autoinheritance_info(void);
          plhs[0] = sf_c3_FLWSim_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "seANfD4gPCuVoQacAHnwobC") == 0) {
     ...
     case 3:
      {
        if (strcmp(instanceChksum, "s3MM37qo4TO8C8qThs59IgG") == 0) {
          extern const mxArray *sf_c3_FLWSim_get_eml_resolved_functions_info
            (void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c3_FLWSim_get_eml_resolved_functions_info();
          plhs[0] = mxDuplicateArray(persistentMxArray);
          mxDestroyArray(persistentMxArray);
          break;
        }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "seANfD4gPCuVoQacAHnwobC") == 0) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "s3MM37qo4TO8C8qThs59IgG") == 0) {
          extern mxArray *sf_c3_FLWSim_third_party_uses_info(void);
          plhs[0] = sf_c3_FLWSim_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "s3MM37qo4TO8C8qThs59IgG") == 0) {
          extern mxArray *sf_c3_FLWSim_jit_fallback_info(void);
          plhs[0] = sf_c3_FLWSim_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "s3MM37qo4TO8C8qThs59IgG") == 0) {
          extern mxArray *sf_c3_FLWSim_updateBuildInfo_args_info(void);
          plhs[0] = sf_c3_FLWSim_updateBuildInfo_args_info();
          break;
        }
      }
