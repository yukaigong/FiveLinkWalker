history_length = 15; % sample num
dop = 10; % deg of polynomial NOTICE! dop too high will make(A'*A) close to singular and cause numeric issue when using code gen mode.
RegressionDelay = 0;
